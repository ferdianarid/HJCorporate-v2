              ...
              <div class="font-sans antialiased" id="app">
                     ...
                     <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
                            ...
                            <div class="text-sm sm:flex-grow sm:text-right">
                                   <div class="mr-40">
                                          <a href="/" class="no-underline block mt-4 sm:mx-3 sm:inline-block sm:mt-0 text-teal-lighter hover:text-green-800 mr-4">
                                          Beranda
                                          </a>
                                          <a href="/partner" class="no-underline block mt-4 sm:mx-3 sm:inline-block sm:mt-0 text-teal-lighter hover:text-green-800 mr-4">
                                          Partner
                                          </a>
                                          <a href="/bisnis" class="no-underline block mt-4 sm:mx-3 sm:inline-block sm:mt-0 text-teal-lighter hover:text-green-800 mr-4">
                                          Bisnis Kami
                                          </a>
